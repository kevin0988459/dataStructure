...

{
	...
	{
		System.setProperty("webdriver.chrome.driver", "/Users/huangkevin/Downloads/chromedriver");
...

	{
	    ...
	    WebElement searchBox = driver.findElement(By.tagName("html"));
		List<WebElement> titles = searchBox.findElements(By.cssSelector("p.nVcaUb"));
		for(WebElement title:titles){
			System.out.println(title.getText());
			System.out.println(title.findElement(By.cssSelector("a[href]")).getAttribute("href"));
